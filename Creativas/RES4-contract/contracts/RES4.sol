...
contract RES4 is ERC721{
   ...
   ////////////////////////////////////////////////////////////////////////////////
    ...
    function addAsset(uint256 price, string memory autor, string memory titulo, uint256 fecha, uint256 frac, string memory tokenCDI, string memory tokenCDI1, address to) public {
        require(supervisor == msg.sender,'NotAManager');
        assetMap[assetsCount] = Asset(assetsCount,price,autor,titulo,fecha,frac,tokenCDI,tokenCDI1);
        mint(to,assetsCount);
    ...
    function build(uint256 assetId,uint256 value) public payable{
        require(isApprovedOrOwner(msg.sender, assetId), "NotAnApprovedowner");
         ...
         assetMap[assetId] = Asset(oldAsset.assetId, oldAsset.price+value, oldAsset.autor, oldAsset.titulo, oldAsset.fecha, oldAsset.frac, oldAsset.tokenCDI, oldAsset.tokenCDI1);
    }
